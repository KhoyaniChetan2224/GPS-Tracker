...
const Home = () => {
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div
        ref={vehiclePanelRef}
        className="fixed w-full z-10 bottom-0 translate-y-full p-3 bg-white py-10 px-3 pt-14"
      >
        <VehiclePanel
      ...
      <div
        ...
        className="fixed w-full z-10 bottom-0 translate-y-full p-3 bg-white py-6 px-3"
      >
        <ConfirmRide
          setConfirmRidePanel={setConfirmRidePanel}
          setVehicalFound={setVehicleFound}
        />
      </div>
      ...
      <div
        ...
        className="fixed w-full z-10 bottom-0  p-3 bg-white py-6 px-3"
      >
        <WaitingForDriver
          ride={ride}
          setVehicleFound={setVehicleFound}
